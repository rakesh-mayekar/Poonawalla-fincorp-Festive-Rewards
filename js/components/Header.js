// Header Component - Refined Single-Line Nav & Play & Win Dropdown
    ...
    <header class="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-wf-border text-wf-text shadow-xs">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 sm:h-20 gap-4">
          ...
          <!-- Home as Logo (Exact Text from Feedback) -->
          <a href="#home" class="flex items-center gap-3 group focus:outline-none flex-shrink-0">
            <div class="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-wf-dark text-white p-0.5 shadow-xs group-hover:scale-105 transition-transform flex items-center justify-center font-outfit font-extrabold text-lg sm:text-xl tracking-tighter">
              PF
            </div>
            <div class="flex flex-col">
              <div class="font-outfit font-extrabold text-lg sm:text-xl text-wf-dark tracking-tight leading-none">
                POONAWALLA FINCORP
              </div>
              <span class="text-[11px] text-wf-subtext font-semibold tracking-wide mt-1">
                Festive Rewards
              </span>
            </div>
          </a>

          <!-- Single Line Desktop Navigation (whitespace-nowrap) -->
          <nav class="hidden lg:flex items-center space-x-2 xl:space-x-4 text-sm font-semibold whitespace-nowrap">
            
            <!-- Play and Win Dropdown Menu -->
            <div class="relative group">
              <button 
                class="px-3.5 py-2 rounded-xl text-wf-dark hover:bg-wf-muted transition-all flex items-center gap-1.5 focus:outline-none"
              >
              ...
              <div class="absolute left-0 top-full pt-1 hidden group-hover:block w-52 z-50 animate-fade-in">
                <div class="bg-white border-2 border-wf-border rounded-2xl shadow-xl p-2 space-y-1">
                  <a 
                    href="#game-spin"
                    class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl hover:bg-wf-muted text-wf-dark text-xs font-bold transition-colors"
                  >
            ...
            <a 
              ...
              class="px-3.5 py-2 rounded-xl text-wf-dark hover:bg-wf-muted transition-all flex items-center gap-1.5"
            >
          ...
          <div class="flex items-center gap-2 sm:gap-3 whitespace-nowrap">
            ${isAuthenticated ? `
              <div class="flex items-center gap-1.5 p-1 pl-3 rounded-xl bg-emerald-50 border border-emerald-300 text-emerald-900 font-semibold text-xs sm:text-sm">
                ...
                <button 
                  ...
                  class="ml-1 p-1.5 rounded-lg bg-emerald-100 hover:bg-rose-100 hover:text-rose-700 text-emerald-800 transition-colors flex items-center gap-1 text-[11px] font-bold"
                >
            ...
            ` : `
              <button 
                id="btn-open-otp"
                class="px-4 py-2.5 rounded-xl bg-wf-dark hover:bg-wf-darkHover text-white font-bold text-xs sm:text-sm flex items-center gap-1.5 shadow-xs active:scale-95 transition-all"
              >
            ...
            <button 
              ...
              class="lg:hidden p-2 rounded-xl bg-wf-muted text-wf-dark focus:outline-none"
            >
        ...
        <div id="mobile-nav-menu" class="hidden lg:hidden border-t border-wf-border py-3 space-y-1">
          <div class="px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-wf-subtext">Play and Win</div>
