...
export function renderHeroSection() {
  ...
  return `
    <section id="hero" class="relative bg-wf-bg text-wf-text overflow-hidden border-b border-wf-border bg-wireframe-grid min-h-[calc(100vh-80px)] flex flex-col justify-between">
