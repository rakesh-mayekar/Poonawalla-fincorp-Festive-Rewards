// Scratch Card Inner Game Tracking Page Component
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-center">
        ...
        <div class="rounded-3xl bg-white border-2 border-wf-border p-6 sm:p-10 shadow-md space-y-6">
          <div class="space-y-2">
            ...
            <p class="text-xs sm:text-sm text-wf-subtext">Scratch off the golden foil layer to reveal your instant gift prize.</p>
          </div>
          ...
          <div class="py-4">
            ...
            >
              ...
              <span>Launch Scratch Card Game</span>
            </button>
          </div>
        </div>
