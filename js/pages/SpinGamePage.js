// Spin & Win Inner Game Tracking Page Component with Pre-Game Mobile Verification
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-center">
        ...
        <div class="rounded-3xl bg-white border-2 border-wf-border p-6 sm:p-10 shadow-md space-y-6 text-left">
          ...
          <div class="space-y-2 text-center">
            ...
            <p class="text-xs sm:text-sm text-wf-subtext">Spin the wheel to win guaranteed gift vouchers from top partner brands.</p>
          </div>
          ...
          ${!isAuthenticated ? `
            ...
            <div class="max-w-md mx-auto p-6 rounded-2xl bg-wf-muted border-2 border-wf-border space-y-4 text-center">
              ...
              <div>
                ...
                <p class="text-xs text-wf-subtext mt-1">Please verify your mobile number to unlock the Spin Wheel game and claim rewards.</p>
              </div>
          ...
          ` : `
            ...
            <div class="max-w-md mx-auto p-6 rounded-2xl bg-emerald-50 border-2 border-emerald-300 space-y-4 text-center">
              ...
              <p class="text-xs text-wf-subtext">Click below to launch the interactive Spin & Win wheel.</p>
